          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6">
              <a href="#" className="best-offer-item">
                <img src="img/best-offers/offer-1.jpg" alt="image" />
              </a>
            </div>
            <div className="col-lg-4 col-md-6">
              <a href="#" className="best-offer-item">
                <img src="img/best-offers/offer-2.jpg" alt="image" />
              </a>
            </div>
            <div className="col-lg-4 col-md-6">
              <a href="#" className="best-offer-item offr-none">
                <img src="img/best-offers/offer-3.jpg" alt="image" />
            ...
            <div className="col-md-12">
              <a href="#" className="code-offer-item">
                <img src="img/best-offers/offer-4.jpg" alt="image" />
              </a>
            </div>
          </div>
        </div>
