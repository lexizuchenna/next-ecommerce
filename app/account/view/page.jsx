          ...
          <div className="col-lg-6 col-md-12">
            <div className="pdpt-bg">
              ...
              <a href="#" className="more-link14">
                Rewards and Details <i className="uil uil-angle-double-right" />
              </a>
            </div>
          </div>
          <div className="col-lg-6 col-md-12">
            <div className="pdpt-bg">
              ...
              <a href="#" className="more-link14">
                All Orders <i className="uil uil-angle-double-right" />
              </a>
            </div>
          </div>
            ...
            <div className="pdpt-bg">
              ...
              <div className="wllt-body">
                ...
                <ul className="wallet-list">
                  ...
                  <li>
                    <a href="#" className="wallet-links14">
                      <i className="uil uil-gift" />3 offers Active
                    </a>
                  </li>
                  <li>
                    <a href="#" className="wallet-links14">
                      <i className="uil uil-coins" />
                      Points Earning
                    </a>
                  </li>
                </ul>
